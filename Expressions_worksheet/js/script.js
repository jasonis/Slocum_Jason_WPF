...
var sparkyAge = 3;  // Sparky's age in human years
var sparkyDogAge = 7 * sparkyAge;  // Sparky's age multiplied by the 7 times faster that dogs age
console.log("Sparky is" + " " + sparkyAge + " " + "human years old which is" + " " + sparkyDogAge + " " + "in dog years");  //  Sparky is 3 human years old which is 21 in dog years.

// Slice of the Pie part 1
// how many slices of pizza will everyone at the party get

var slicesPerPizza = 8;  // this is the number of slices per pizza 8
var partyPeople = 20;  // there are 20 people ot the party
var pizzas = 5;  // they ordered 5 pizzas
var slicesPerPerson = slicesPerPizza * pizzas / partyPeople; // 8 slices times 5 pizzas divided by 20 people
console.log("Each person ate" + " " + slicesPerPerson + " " + "slices of pizza at the party");  // each person ate 2 slices of pizza at the party
...
console.log("Sparky got" + " " + sparkySlices + " " + "slices of pizza");  // Sorry sparky there is none left for you
...
console.log("You have spent a total of $" + totalBill + " " + "on groceries over 5 weeks.  That is an average of $" + averageBill + " " + "per week");  // $36.8 is the average weekly grocery bill
...
console.log("Your shirt was originally $" + shirt + ", " + "but after a" + " " + discount + "%, " + "it is now $" + discountedShirt + " " + "without tax, and $" + total + " " + "with tax");  //the total price of the $14 shirt minus the 10% discount plus 5% sales tax is $13.23
