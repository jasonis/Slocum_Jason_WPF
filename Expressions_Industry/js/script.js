...
console.log("Your average computer screen in your house is " + averageSize + " inches");// print out of your average screen size along with text to explain the number